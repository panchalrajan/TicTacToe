...
class VsPlayerVC: UIViewController {
    ...
    @objc func cellTapped(_ sender: UITapGestureRecognizer) {
        ...
        let hasWinningMoves = checkForWinningMoves(playerMoves: currentPlayer == 1 ? player1Moves : player2Moves)
        
        if hasWinningMoves {
            presentAlertWithRestart(title: "Congratulations!", message: "Player \(currentPlayer) wins!")
        } else if player1Moves.count + player2Moves.count == 9 {
            presentAlertWithRestart(title: "Tie!", message: "It's a tie!")
        } else {
